        ...
        <div className='col-lg-12'>
          ...
          <div className='ls-widget' id='linkWallet'>
            <div className='tabs-box'>
              <div className='widget-title'>
                <ReactTooltip
                  id='linked-wallets-tooltip'
                  place='right'
                  content='Crypto wallet addresses linked to this account'
                />
                <h4 data-tooltip-id='linked-wallets-tooltip'>
                  Linked Wallets
                </h4>
              </div>
...
export default TalentAccountSettings;
